...
if ( ! function_exists('other_accessories') ) {

// Register Custom Post Type
function other_accessories() {

	$labels = array(
		'name'                  => _x( 'Other Parts/Accessories', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Other Parts/Accessories', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Other Parts/Accessories', 'text_domain' ),
		'name_admin_bar'        => __( 'Other Parts/Accessories', 'text_domain' ),
		'archives'              => __( 'Other Parts/Accessories Archives', 'text_domain' ),
		'attributes'            => __( 'Other Parts/Accessories Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'All Other Parts/Accessories', 'text_domain' ),
		'add_new_item'          => __( 'Add New Item', 'text_domain' ),
		'add_new'               => __( 'Add New', 'text_domain' ),
		'new_item'              => __( 'New Item', 'text_domain' ),
		'edit_item'             => __( 'Edit Item', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Other Parts/Accessories', 'text_domain' ),
		'description'           => __( 'Post Type Description', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
		'hierarchical'          => false,
	...
	register_post_type( 'other_accessories', $args );

}
add_action( 'init', 'other_accessories', 0 );
...
function sold_instruments_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
		'taxonomies'            => array( 'sold_instrument_brand', 'age_group', 'instrument_type' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
